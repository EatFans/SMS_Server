...
public class TestProcessor implements Processor {
    @RequestMapping(requestUrl = "/test",requestType = RequestType.POST)
    public String test(Request request){
        ...
        response.setStatus(HttpStatus.OK.getCode(), HttpStatus.OK.getReasonPhrase());
        response.addHeader("Content-Type",ContentType.APPLICATION_JSON);
        response.setBody(testMessage);
